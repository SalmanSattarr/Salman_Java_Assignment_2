...
public class Warsim {
    ...
    public static void enemyTurn() {
        ...
        System.out.println("The enemy is preparing to attack...");
        // Simulate enemy preparing to attack
        System.out.println("The enemy unleashes a devastating attack!");
        int damage = eWeapon.strike(weather.getSeverity(), attackType, enemy.getStrength(), enemy.getDexterity());
        damage = pArmour.reduceDamage(damage);
        if (randNum.nextDouble() < 0.7) { // 70% chance of landing a critical hit
            damage *= 2; // double the damage for a critical hit
            System.out.println("The enemy lands a critical hit!");
        }
        System.out.println("You take " + damage + " damage from the enemy's attack!");
